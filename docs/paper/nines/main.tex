...
while a commit-only $(0,1)$ incumbent with a round budget of 8---equal to the healthy proposer's own fixed budget---exhausted the healthy proposer's progress budget (0/50 completions, drawn as a minimal stub for visibility).}\label{fig:experimental-reversal}
\end{figure}
