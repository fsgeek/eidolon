...
We take that safety freedom as the starting point and ask what it does to operational capability. The result is a complete classification for any finite pair of quorum families: containment tells us which mixed states the system admits, and the auditor makes that classification executable.
