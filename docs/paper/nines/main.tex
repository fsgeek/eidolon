...
\end{enumerate}
Each empirical claim is tied to an executable artifact and output file (\autoref{app:traceability}). All results are design-level; deployment would introduce orbital dynamics, antenna scheduling, and variable link quality not modeled here.
