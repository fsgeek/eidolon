...
The readout assumes supplied connectivity. It detects no failure and establishes neither fresh runtime authority nor a chosen value. It supplies no chosen client contract; service policy and operator action remain outside the interface. The wall's linear readout also depends on one anchor tier; multi-anchor families may change both resilience and legibility.
