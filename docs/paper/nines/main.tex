...
Per-phase timeout & 500~s global; 1~s local & global budget raised to $1.25\times$ the worst-case request--response path when that exceeds the base (above ${\approx}200$~s Mars delay) \\
